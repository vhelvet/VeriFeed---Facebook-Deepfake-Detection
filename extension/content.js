            ...
            try {
                ...
                timeoutId = setTimeout(() => {
                    if (!hasResolved) {
                        ...
                        console.warn(`[VeriFeed] ⏱️ Timeout - captured ${frames.length} frames`);
                ...
                for (const time of targetTimes) {
                    ...
                    if (frames.length % 50 === 0) {
                        ...
                        console.log(`[VeriFeed] Captured ${frames.length} frames in ${elapsed}s`);
                    }
                }
