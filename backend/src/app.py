...
ALLOWED_ORIGINS = os.environ.get('ALLOWED_ORIGINS', 
    'chrome-extension://iljbbfgejddphakhekbonjioflbodjoh,ms-browser-extension://pjebiibiippeffhmimailefekjgcbgbm/*,ms-browser-extension://oekbgfgljexjhfingafboenphifoifog/*,http://localhost,http://127.0.0.1'
).split(',')
...
# Use a writeable temporary directory for downloads
